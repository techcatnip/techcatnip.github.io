...
function createtime1() {
  var grt = new Date("08/20/2022 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by TechCat %c 你正在访问 TechCat の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| TechCat🍅") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('TechCat🍅的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
if (m == 9 && dd == 6) {//站长生日
  if (sessionStorage.getItem("isPopupWindow") != "1") {
    Swal.fire("祝站长" + (y - 1990).toString() + "岁生日快乐！");
    sessionStorage.setItem("isPopupWindow", "1");
  }
}
if (m == 6 && dd == 16) {//小猫咪生日
  if (sessionStorage.getItem("isPopupWindow") != "1") {
    Swal.fire("祝小猫咪" + (y - 1990).toString() + "岁生日快乐！🐱");
    sessionStorage.setItem("isPopupWindow", "1");
  }
}
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("08/20/2022 00:00:00");
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/home_bg.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/home_bg.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/mantouxia/kelilove/81470077.png)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/mantouxia/kelilove/81470077.png)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s3.bmp.ovh/imgs/2023/08/27/1f9e6e52d3c3f403.jpg)" class="imgbox" onclick="changeBg('url(https://s3.bmp.ovh/imgs/2023/08/27/1f9e6e52d3c3f403.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s3.bmp.ovh/imgs/2023/08/27/08bf119d1c59c644.jpg)" class="imgbox" onclick="changeBg('url(https://s3.bmp.ovh/imgs/2023/08/27/08bf119d1c59c644.jpg)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/fj1.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/fj1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://cdn.jsdelivr.net/gh/mantouxia/kelilove/grgh.jpg)" class="imgbox" onclick="changeBg('url(https://cdn.jsdelivr.net/gh/mantouxia/kelilove/grgh.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s3.bmp.ovh/imgs/2023/08/27/9b51b7faa22111a9.webp)" class="imgbox" onclick="changeBg('url(https://s3.bmp.ovh/imgs/2023/08/27/9b51b7faa22111a9.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s3.bmp.ovh/imgs/2023/08/27/9b51b7faa22111a9.webp)" class="imgbox" onclick="changeBg('url(https://s3.bmp.ovh/imgs/2023/08/27/9b51b7faa22111a9.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Fomalhaut/img/mc1.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Fomalhaut/img/mc1.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s3.bmp.ovh/imgs/2023/08/27/533bec994227aa31.jpg)" class="imgbox" onclick="changeBg('url(https://s3.bmp.ovh/imgs/2023/08/27/533bec994227aa31.jpg)')"></a></div>
              </div>
            </details>
